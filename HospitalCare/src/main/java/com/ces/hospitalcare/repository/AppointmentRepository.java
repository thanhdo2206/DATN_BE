...
public interface AppointmentRepository extends JpaRepository<AppointmentEntity, Long> {
    ...
    List<AppointmentEntity> getAllByDoctorIdAndPatientIdOrderByModifiedDateDesc(Long doctorId, Long patientId);

    AppointmentEntity getByIdAndDoctorId(Long id, Long doctorId);

    List<AppointmentEntity> findAllByStatusAndDoctorIdOrderByModifiedDateDesc(int status, Long doctorId, Pageable pageable);
